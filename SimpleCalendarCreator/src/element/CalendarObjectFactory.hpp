...
public:
    /**
     * @brief Create object from class name.
    ...
    /**
     * @brief Get calendar object's class name from readable name.
     * @param name Readable name of a calendar object.
     * @throw std::out_of_range if @p is not registered.
     */
    QString getObjectClassName(const QString& name) const;
    /**
     * @brief Get all avaliable calendar objects' readable name.
     */
...
private:
    /**
     * @internal
     * @brief Map Calendar Objects' class name to relative creator function.
     */
    static const std::map<QString, std::function<std::unique_ptr<element::Element>()>>* objCreator;
    /**
     * @internal
     * @brief Map Calendar Objects' readable name to class name.
     */
